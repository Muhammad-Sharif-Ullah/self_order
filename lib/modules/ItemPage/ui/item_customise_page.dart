     ...
     body: Column(
       children: [
                       ...
                       child: Column(
                         ...
                         children: [
                           ...
                           GridView.builder(
                             itemCount: 18,
                              shrinkWrap: true,
                               gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 5,childAspectRatio: 2,crossAxisSpacing: 10,mainAxisSpacing: 10),
                               itemBuilder: (context, index){
                                return Stack(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(color: ColorConstants.borderColor.withOpacity(0.02))

                                      ),
                                      child: Center(
                                        child: Text('Beef',style: TextStyle(
                                          color: ColorConstants.primaryBigTextColor,
                                          fontSize: 14.sp,
                                          fontWeight: FontWeight.w400,
                                        ),),
         ...
         Padding(
           ...
           child: InkWell(
             onTap: (){
               Navigator.pushNamed(context, '/checkoutPage',arguments: PageRouteArguments(
                 data: [],
                 toPage: "checkoutPage",
